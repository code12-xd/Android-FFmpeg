...
COMMON_OPTIONS="
    ...
    "
EXTRA_CFLAGS="-fdata-sections -ffunction-sections -fstack-protector-strong -ffast-math -fstrict-aliasing -march=$ARCH -D__ANDROID_API__=23 -isystem $NDK_PATH/sysroot/usr/include -isystem $NDK_PATH/sysroot/usr/include/arm-linux-androideabi"
